...
import arcsecond from '../../src';
// import sinon from 'sinon';

describe('Arcsecond', () => {
	it('should create an endpoint with correct default url and provided API version when it is called', () => {
		const client = arcsecond('1');
		expect(client.url()).to.equal('http://api.arcsecond.io/1');
	});
